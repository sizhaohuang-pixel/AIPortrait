<template>
    <div class="default-main ba-table-box">
        ...
        <TableHeader
            ...
            :quick-search-placeholder="'快速搜索：风格名称'"
        />
...
const baTable = new baTableClass(
    new baTableApi('/admin/ai.Style/'),
    {
        column: [
            { type: 'selection', align: 'center', operator: false },
            { label: 'ID', prop: 'id', align: 'center', operator: '=', operatorPlaceholder: 'ID', width: 70 },
            { label: '风格名称', prop: 'name', align: 'center', operator: 'LIKE', operatorPlaceholder: '模糊查询' },
            { label: '图标', prop: 'icon', align: 'center', render: 'image', operator: false, width: 100 },
